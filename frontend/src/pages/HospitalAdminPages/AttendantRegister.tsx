...
const AttendantRegister = () => {
    ...
    const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
        ...
        try {
            ...
            await axios.post(`${API_BASE_URL}/api/hospitals/attendants`, {
                name: formData.name,
            ...
            navigate('/hospital-dashboard', { state: { AttendantRegistered: true } });
        } catch (error: unknown) {
    ...
    return (
        <div className="booking-container">
            <h2>Register Attendant</h2>
            <p style={{ color: '#475569', fontSize: '14px', marginBottom: '20px', textAlign: 'center' }}>
                Register Attendants to Manage Your Hospital Care Packages
            </p>
            ...
            <form onSubmit={handleSubmit} className="booking-form">
                ...
                <button type="submit" className="booking-button" disabled={isSubmitting}>
                    {isSubmitting ? 'AttendantRegistering...' : 'AttendantRegister'}
                </button>
            </form>
        </div>
    );
